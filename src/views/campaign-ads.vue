    ...
    <div class="campaign__ads">
        ...
        >
            <div
                ...
                @click="selectAdsType(type.id, type.type)"
            >
                <b-card
                    body-class="d-flex flex-column"
                    :class="campaign.ads_type === type.id ? 'is-active' : ''"
        ...
        >
            ...
            >
                <b-card
                    ...
                    v-if="campaign.ads_type===type.id"
                >
                    <b-card-text>
...
export default {
    ...
    methods: {
        selectAdsType(id, type) {
            if (this.showLoaderSending) {
                return;
            }
            this.campaign.ads_type = id;
            this.campaign.ads_type_str = type;
